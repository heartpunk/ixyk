...
def run(a):
    ...
    subprocess.run([sys.executable,'-m','inventory.utility_facts','--module',f'xed={a.binary}={a.gtirb}','--root','decoder=ixyk_decode_bytes','--root','initialization=xed_tables_init','--out',str(facts)],check=True)
